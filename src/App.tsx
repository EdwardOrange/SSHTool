...
export default function App({ mode, toggleMode }: { mode: "light" | "dark"; toggleMode: () => void }) {
  ...
  const { hosts, setHosts, selectedHostId, page, setPage, upsertHost, setCommands, addCommand, setSettings } = useAppStore();
  ...
  return <Box sx={{ height: "100%", display: "flex", flexDirection: "column" }}>
    ...
    <HostDialog open={hostDialog} onClose={() => setHostDialog(false)}/>
